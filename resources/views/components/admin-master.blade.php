...
<title>Admin Panel of {{Auth::user()->name}}</title>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
           ...
           <x-.admin.navbar.admin-navbar-user-information></x-.admin.navbar.admin-navbar-user-information>
          </ul>
  ...
  <!-- Logout Modal (in admin-navbar-user-inforamtion component) -->
